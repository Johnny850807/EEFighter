...
public class SmileFace extends GraphicStrategy {

	public SmileFace(int x, int y, int width, int height) {
	...
	public void draw(Graphics g) {
        ...
        g.drawArc(x + (int)(width / 3), y + (int)(height / 5) * 3, (int)(width / 3), (int)(height / 6), 180, 180); 
	}
