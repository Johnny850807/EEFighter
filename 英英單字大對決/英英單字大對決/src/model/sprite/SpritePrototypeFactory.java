...
public class SpritePrototypeFactory {
	...
	public void prepareSprites() throws IOException {
		...
		spriteMap.put(SpriteName.PLAYER1,
				new PlayerSprite(60, 60, 130, 125, 25, 25, SpriteName.PLAYER1, player1ImageMap));
		spriteMap.put(SpriteName.PLAYER2, new PlayerSprite(60, 60, 130, 125, 30, 30, SpriteName.PLAYER2, player2ImageMap));
	}
