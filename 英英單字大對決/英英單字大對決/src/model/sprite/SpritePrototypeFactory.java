...
public class SpritePrototypeFactory {
	...
	public void prepareSprites() throws IOException {
		...
		spriteMap.put(SpriteName.C, new Sprite(64, 64, 22, 22, 47, 40, SpriteName.C, createImageMap(ImageIO.read(new File("pic/C.png")))));
		...
		spriteMap.put(SpriteName.I, new Sprite(64, 64, 29, 7, 35, 57, SpriteName.I, createImageMap(ImageIO.read(new File("pic/I.png")))));
