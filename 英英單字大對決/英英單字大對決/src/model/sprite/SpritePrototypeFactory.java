...
public class SpritePrototypeFactory {
	...
	public void prepareSprites() throws IOException {
		...
		spriteMap.put(SpriteName.C, new Sprite(64, 64, 25, 25, 47, 40, SpriteName.C, createImageMap(ImageIO.read(new File("pic/C.png")))));
		spriteMap.put(SpriteName.D, new Sprite(64, 64, 18, 18, 50, 50, SpriteName.D, createImageMap(ImageIO.read(new File("pic/D.png")))));
		spriteMap.put(SpriteName.E, new Sprite(64, 64, 22, 18, 42, 46, SpriteName.E, createImageMap(ImageIO.read(new File("pic/E.png")))));
		spriteMap.put(SpriteName.F, new Sprite(64, 64, 22, 20, 44, 44, SpriteName.F, createImageMap(ImageIO.read(new File("pic/F.png")))));
		...
		spriteMap.put(SpriteName.J, new Sprite(64, 64, 26, 23, 40, 40, SpriteName.J, createImageMap(ImageIO.read(new File("pic/J.png")))));
		...
		spriteMap.put(SpriteName.M, new Sprite(64, 64, 10, 15, 54, 48, SpriteName.M, createImageMap(ImageIO.read(new File("pic/M.png")))));
		spriteMap.put(SpriteName.N, new Sprite(64, 64, 17, 19, 45, 45, SpriteName.N, createImageMap(ImageIO.read(new File("pic/N.png")))));
		spriteMap.put(SpriteName.O, new Sprite(64, 64, 22, 19, 50, 45, SpriteName.O, createImageMap(ImageIO.read(new File("pic/O.png")))));
		spriteMap.put(SpriteName.P, new Sprite(64, 64, 23, 23, 40, 40, SpriteName.P, createImageMap(ImageIO.read(new File("pic/P.png")))));
		spriteMap.put(SpriteName.Q, new Sprite(64, 64, 19, 19, 50, 45, SpriteName.Q, createImageMap(ImageIO.read(new File("pic/Q.png")))));
		spriteMap.put(SpriteName.R, new Sprite(64, 64, 21, 19, 40, 45, SpriteName.R, createImageMap(ImageIO.read(new File("pic/R.png")))));
		...
		spriteMap.put(SpriteName.X, new Sprite(64, 64, 10, 15, 50, 50, SpriteName.X, createImageMap(ImageIO.read(new File("pic/X.png")))));
